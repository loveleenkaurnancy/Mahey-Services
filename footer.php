          ...
          <div class="row">
            <div class="col-lg-3 col-sm-3">
              <section class="footer-section">
                ...
                <div class="footer-contacts"> <i class="icon stroke icon-Phone2"></i> <span class="footer-contacts__inner"> +91-98551-65444</span> </div>
                <div class="footer-contacts"> <i class="icon stroke icon-Phone2"></i> <span class="footer-contacts__inner"> +91-98556-65444</span> </div>
                <div class="footer-contacts"> <i class="icon stroke icon-Mail"></i> <a class="footer-contacts__inner" href="mailto:Info@academica.com">maheyservices@gmail.com</a> </div>
              </section>
              <!-- end footer-section --> 
            </div>
            <!-- end col -->
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="footer-bottom">
              <div class="copyright">Copyright © 2018 <a href="javascript:void(0);">Mahey Services</a> |  Created by <a href="javascript:void(0);">Loveleen Kaur</a></div>
